...
/**
 * Performance test for the Instance entity.
 */
class InstanceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Instance entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created instance")
                .get("${new_instance_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created instance")
            .delete("${new_instance_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
